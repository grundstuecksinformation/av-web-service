...
curl -X GET -H "Accept: application/xml" -H "Content-Type: application/xml" http://localhost:8080/getegrid/xml/CH707406053288/452 > response.xml && xmllint --format response.xml
